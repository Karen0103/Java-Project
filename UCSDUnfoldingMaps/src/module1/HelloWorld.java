...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		this.background(122, 197, 205); //###set to lake blue
		
		// Select a map provider
		//###since google can't be used in China, I chane provider to Microsoft
		...
		map2 = new UnfoldingMap(this, 420, 50, 350, 500, provider); // x axis is horizontal
		map2.zoomAndPanTo(zoomLevel, new Location(32.044f, 118.855f)); 
